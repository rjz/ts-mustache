...
*/`,
    ...
    if (args.node) {
        ...
        footer.push(`export const TEMPLATE_DIR = path.resolve(__dirname, '${path_1.default.relative(path_1.default.dirname((_a = args.o) !== null && _a !== void 0 ? _a : '.'), path_1.default.resolve(args.dir))}')`);
    }
